...
/**
 * Save a reference to the clearTimeout method, so that it doesn't get
 * wiped out by mock clocks.
 * @private {!Function}
 */
goog.async.Deferred.clearTimeout_ = goog.global.clearTimeout;
...
goog.async.Deferred.Error_ = function(id, error) {
  ...
  /** @private {number} */
  this.timeoutId_ = goog.async.Deferred.setTimeout_.call(goog.global, goog.bind(this.throwError, this), 0);
};
...
goog.async.Deferred.Error_.prototype.resetTimer = function() {
  goog.async.Deferred.clearTimeout_.call(goog.global, this.timeoutId_);
};
